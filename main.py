...
Original file is located at
    https://colab.research.google.com/drive/1722euDj2vNXz7Y6QcyKrsIHUdEUcgKSO
...
work_in_class = float(input("Enter your work in class score (0-100): "))
test = float(input("Enter your test score (0-100): "))
project = float(input("Enter your project score (0-100): "))


overall_grade = 0.2 * work_in_class + 0.3 * test + 0.5 * project
...
print("Your Polish grade is:", polish_grade)
...
if side1 + side2 > side3 and side1 + side3 > side2 and side2 + side3 > side1:
    ...
    print("triangle cant be drawn with the given sides")
